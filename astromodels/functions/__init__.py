...
from .functions_2D import (Asymm_Gaussian_on_sphere, Disk_on_sphere,
                           ...
                           SpatialTemplate_2D, GeneralizedGaussianSpatialModel)
...
__all__ = [
    ...
    "SpatialTemplate_2D", "GeneralizedGaussianSpatialModel", "Continuous_injection_diffusion",
    "Continuous_injection_diffusion_ellipse", 
    "Continuous_injection_diffusion_legacy", "GalPropTemplate_3D", "Hermes", "DMSpectra",
